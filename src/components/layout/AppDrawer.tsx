  ...
  return (
    <Box sx={{ display: "flex" }}>
        ...
        <List>
          {buttonsinfo.map((info, index) => (
            ...
            >
              <ListItemIcon>
                {index === 0 ? (
                  <MailIcon color={index === value ? "primary" : "inherit"} />
                ) : index === 1 ? (
                  <MailIcon color={index === value ? "primary" : "inherit"} />
                ) : index === 2 ? (
                  <MailIcon color={index === value ? "primary" : "inherit"} />
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <DrawerHeader />
        <div hidden={value !== 0}>Test</div>
        <div hidden={value !== 1}>Test1</div>
        <div hidden={value !== 2}>Test2</div>
        <div hidden={value !== 3}>Test3</div>
